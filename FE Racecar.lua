...
local Gui = Rayfield:CreateWindow({
	Name = "Race Car V2",
	LoadingTitle = "Race Car V2",
	LoadingSubtitle = "by Spect",
	ConfigurationSaving = {
		Enabled = false,
		FolderName = "DRIFTERRHUB",
		FileName = "DrifterHub",
	},
	Discord = {
		Enabled = true,
...
local Label = Tab:CreateLabel("Enjoy! :) This also works with R15 btw.")
...
local DestroyGui = Settings:CreateButton({
	Name = "Destroy Race Car V2",
	Callback = function()
		Rayfield:Destroy()
	end,
 })
-- hat https://www.roblox.com/catalog/4585144193/Elitoria-RN750